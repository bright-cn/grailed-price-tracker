"""
Grailed Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Grailed.

Docs  : https://docs.bright.cn/scraping-automation/web-scraper-api/overview
Info  : https://bright.cn/products/insights/price-tracker/grailed
"""
...
# Set your Web Scraper ID after building your Grailed scraper:
# https://bright.cn/products/web-scraper/grailed
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Grailed scraper at: https://bright.cn/products/web-scraper/grailed\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Grailed product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Grailed products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Grailed category page.

    Example:
        results = discover_by_category("https://grailed.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.grailed.com/product/sample-item-123456",
        # Add more Grailed product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "grailed_prices.json"
    ...
    # cat_results = discover_by_category("https://grailed.com/category/sample", limit=50)
